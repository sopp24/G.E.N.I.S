const CACHE='genis-v1';
const SHELL=['./','./index.html','./styles.css','./app.js','./storage.js','./voice.js','./waveform.js','./brain.js','./tools.js','./index.js','./manifest.webmanifest','./genis-192.png','./genis-512.png'];
